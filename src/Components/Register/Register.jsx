...
const Register = () => {
  ...
  const submitFunc = () => {
    ...
    const userData = {
      ...
      maritalStatus,
      cnic,
      dob, // Make sure the format matches what your backend expects
      insuranceID: insuranceId,
      password,
      favouriteNovel: favoriteNovel, // Adjust for spelling as per your backend field
      gender,
      phoneNumber,
      emergencyContact,
    ...
    fetch('http://localhost:3001/MartinDow/signup', {
      ...
      .then((data) => {
        if (data.status === 'email sent successfully, patient registered') {
      ...
      <div className='contain3'>
        <form className='newReg'>
          ...
          <div className='row5'>
            ...
            <label className='emerRel'>Emergency Contact Relation:  
              <input type="text" value={emergencyContactRelation} onChange={(e)=> setEmergencyContactRelation(e.target.value)} />
            </label>            
            <label className='emerEmail'>Emergency Contact Email:  
